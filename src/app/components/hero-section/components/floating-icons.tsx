...
const ICONS = [
  {
    ...
    alt: "Ethereum",
    className: "absolute top-[20%] left-[25%] h-16 w-16",
  },
  {
    src: "/assets/icons/polygon.svg",
    alt: "Base",
    className: "absolute top-[15%] right-[27%] h-16 w-16",
  },
  {
    src: "/assets/icons/binance-logo-dark.svg",
    alt: "Aptos",
    className: "absolute top-[34%] left-[3%] h-16 w-16 blur-[8px]",
  },
  {
    src: "/assets/icons/sol.svg",
    alt: "Solana",
    className: "absolute top-[55%] left-[23%] h-16 w-16",
  },
  {
    src: "/assets/icons/binance-logo-dark.svg",
    alt: "Binance",
    className: "absolute top-[47%] right-[32%] h-16 w-16",
  },
  {
    src: "/assets/icons/base.svg",
    alt: "Polygon",
    className: "absolute bottom-[63%] right-[5%] h-16 w-16 blur-[8px]",
  },
];
